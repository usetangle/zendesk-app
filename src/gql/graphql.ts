...
export type StatusQuery = { __typename?: 'Query', subscription: { __typename?: 'Subscription', status: SubscriptionStatus, trialEndsAt?: any | null, hasPaymentMethod?: boolean | null }, mode: { __typename?: 'Mode', isDemo: boolean } };
